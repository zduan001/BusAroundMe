...
namespace LeetCodeCsharpTest
{
    ...
    public class UnitTest_All
    {
        ...
        [TestMethod]
        public void Test_021_ZigzagTree()
        {
            _021_ZigzagTree target = new _021_ZigzagTree();
            string inputstring = "5,4,11,#,#,2,#,#,8,13,#,#,4,5,#,#,1,#,#";
            char t = ',';
            TreeNode root = TreeNode.DeserializeTree(inputstring, t);
            List<int> actual = target.PrintZigzagTree(root);
